...
-->
<div
	class="flex h-[calc(100dvh_-_2_*_var(--shell-gap)_-_var(--header-height)_-_72px)] min-h-[32rem] flex-col gap-4"
>
	<PageHeader.Root>
		<PageHeader.Title />
	</PageHeader.Root>
		...
		>
			{#snippet children(chat)}
				...
				<!--
					...
					question, and the foot of the page once there is a conversation to
