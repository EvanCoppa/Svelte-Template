...
import { completeTask, createTask, deleteTask, getTask, listTasks, setTaskStatus } from './tasks';
...
describe('tasks data access', () => {
	...
	it('moves a task by writing the status alone', async () => {
		...
		// set and clear (the task_workflow migration), so a move never carries a
