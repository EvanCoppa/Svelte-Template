<script lang="ts">
	...
	const {
		...
		thumbnails: [images.video1Poster, images.video2Poster],
		videoUrls: [images.video1, images.video2],
		links: [text.link1, text.link2],
		captions: [text.caption1, text.caption2]
	});
