...
export const TOOL_LABELS = {
	...
	searchEmails: { running: 'Finding email conversations', done: 'Found email conversations' },
	readEmailThread: { running: 'Reading an email thread', done: 'Read an email thread' }
