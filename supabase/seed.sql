...
--   Acme (general):        e2e holds general 'Support' (tickets manage, companies/contacts read, library pages read)
--   Globex (construction): dev holds construction 'Support' (companies/contacts manage)
